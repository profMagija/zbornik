...
\Figure{figure_1.jpg}
    {Upravljanje raskrsnicom sa dve faze u fiksnom režimu.}
...
\Figure{figure_2.jpg}
    {Broj faza i raspored saobraćajnih traka za test scenario 1, 2 i 3}
    {Number of phases and schedule of traffic lanes for test scenario 1,2 and 3}

\Figure{figure_3.jpg}
    {Test raskrsnica za scenario 1.}
    {Test intersection for test scenario 1.}

\Figure{figure_4.jpg}
    {Test raskrsnica za scenario 2.}
    {Test intersection for test scenario 2.}

\Figure{figure_5.jpg}
    {Test raskrsnica za scenario 3.}
    {Test intersection for test scenario 3.}

\Figure{figure_6.jpg}
    {Test raskrsnica: Kneza Miloša - Bulevar K. A. - Takovska.}
    {Test intersection: Kneza Miloša - Bulevar K. A. - Takovska.}

\TableDouble{
    \begin{tabular}{c|c|ccccc}
        \multicolumn{2}{c|}{Broj faza} & 2 & 3 & 4 & 5 & 6 \\
        \hline
        \multirow{3}{*}{GSA} & \makecell{Vrednost funkcije cilja\\ (s/voz)} & 10.85   & 19.90    & 34.98          & 56.23              & 104.50                 \\
                             & Vreme ciklusa (s)                            & 30      & 42       & 75             & 82                 & 120                    \\
                             & Zelena vremena (s)                           & 10, 10  & 12, 9, 9 & \makecell{18, 14,\\ 15, 14} & \makecell{17, 11, 13,\\ 13, 12} & \makecell{18, 18, 15,\\ 17, 18, 16} \\
        \hline
        \multirow{3}{*}{PSO} & \makecell{Vrednost funkcije cilja\\ (s/voz)} & 10.85   & 19.15    & 30.83          & 54.44              & 104.50                 \\
                             & Vreme ciklusa (s)                            & 30      & 39       & 53             & 86                 & 120                    \\
                             & Zelena vremena (s)                           & 10, 10  & 11, 9, 7 & \makecell{11, 8,\\ 11, 9  } & \makecell{16, 12, 14,\\ 15, 13} & \makecell{18, 18, 15,\\ 17, 18, 16} \\
        \hline
        \multirow{3}{*}{BCO} & \makecell{Vrednost funkcije cilja\\ (s/voz)} & 10.85   & 19.15    & 30.83          & 54.20              & 104.50                 \\
                             & Vreme ciklusa (s)                            & 30      & 39       & 53             & 81                 & 120                    \\
                             & Zelena vremena (s)                           & 10, 10  & 11, 9, 7 & \makecell{11, 8,\\ 11, 9  } & \makecell{15, 11, 13,\\ 14, 12} & \makecell{18, 18, 15,\\ 17, 18, 16} \\
    \end{tabular}
}
    {Upoređivanje metoda za test scenario 1}
    {Comparison of methods for test scenario 1}
...
\TableDouble{
    \begin{tabular}{c|c|ccccc}
        \multicolumn{2}{c|}{Broj faza} & 2 & 3 & 4 & 5 & 6 \\
        \hline
        \multirow{3}{*}{GSA} & \makecell{Vrednost funkcije cilja\\ (s/voz)} & 264.86 & 379.78 & 344.99 & 709.55 & 1277.98   \\
                             & Vreme ciklusa (s)                            &  120 & 120 & 120 & 120 & 120        \\
                             & Zelena vremena (s)                           & 55, 55  & 51, 43, 14 & \makecell{42, 7,\\ 42, 15} & \makecell{36, 7, 36,\\ 12, 13} & \makecell{31, 12, 7,\\ 30, 10, 12} \\
                             & $Q_b / Q_{b+1}$ & 0 / 518  & 0 / 710 & 0 / 640 & 0 / 1276 & 0 / 2028 \\
        \hline
        \multirow{4}{*}{PSO} & \makecell{Vrednost funkcije cilja\\ (s/voz)} & 264.86 & 379.78 & 344.99 & 709.55 & 1277.98   \\
                             & Vreme ciklusa (s)                            &  120 & 120 & 120 & 120 & 120        \\
                             & Zelena vremena (s)                           & 55, 55  & 51, 43, 14 & \makecell{42, 7,\\ 42, 15} & \makecell{36, 7, 36,\\ 12, 13} & \makecell{31, 12, 7,\\ 30, 10, 12} \\
                             & $Q_b / Q_{b+1}$ & 0 / 518  & 0 / 710 & 0 / 640 & 0 / 1276 & 0 / 2028 \\
        \hline
        \multirow{4}{*}{BCO} & \makecell{Vrednost funkcije cilja\\ (s/voz)} & 264.86 & 379.78 & 344.99 & 709.55 & 1277.98   \\
                             & Vreme ciklusa (s)                            &  120 & 120 & 120 & 120 & 120        \\
                             & Zelena vremena (s)                           & 55, 55  & 51, 43, 14 & \makecell{42, 7,\\ 42, 15} & \makecell{36, 7, 36,\\ 12, 13} & \makecell{31, 12, 7,\\ 30, 10, 12} \\
                             & $Q_b / Q_{b+1}$ & 0 / 518  & 0 / 710 & 0 / 640 & 0 / 1276 & 0 / 2028 \\
    \end{tabular}
}
    {Upoređivanje metoda za test scenario 2. Period analize $b = 1$.}
    {Comparison of methods for test scenario 2. Analysis period $b = 1$.}
