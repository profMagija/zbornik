\hyphenation{do-de-lje-na Ne-op-slu-že-nih}
...
U ovom poglavlju su dati grafici konvergencije GSA i PSO algoritama za svaki test primer (slike 6, 7, 8, 9, 10, 11, 12, 13 i 14). Na osnovu njih se može zaključiti da oba algoritma brže konvergiraju ka rešenju.
...
\Figure{plot_1.pdf}{Konvergencija GSA algoritma za test scenario 1}{Convergence curve of GSA algorithm for test scenario 1}

\Figure{plot_2.pdf}{Konvergencija PSO algoritma za test scenario 1}{Convergence curve of PSO algorithm for test scenario 1}
...
\TableDouble{
      \begin{tabular}{p{0.12\linewidth}p{0.12\linewidth}p{0.1\linewidth}p{0.08\linewidth}p{0.08\linewidth}p{0.08\linewidth}p{0.08\linewidth}p{0.08\linewidth}}
        ...
        \hline
      \end{tabular}
}{Upoređivanje metoda za test scenario 1}{Comparison of methods for test scenario 1}

Drugi test scenario ima dva perioda analize koji je napravljen tako da su saobraćajni tokovi raskrsnica prezasićeni. S obzirom na to, javljaju se redovi neopsluženih vozila koji su prikazani u vrsti $Q_b / Q_{b+1}$ u tabeli 2. i 3. Pretpostavljeno je da pre prvog perioda ($b=1$) na raskrsnici nema neopsluženih vozila, odnosno da je $Q_b = 0$ za sve trake na raskrsnici. Poređenjem ovih metoda, pokazalo se da PSO i GSA algoritam generišu ista rešenja za sve razmatrane slučajeve u prvom i drugom periodu analize. U prvom periodu analize, GSA je uspeo da nađe optimalna rešenja za raskrsnicu sa 2 i 4 faze, dok je u drugom periodu analize uspeo da nađe samo optimalno rešenje u slučaju raskrsnice sa dve faze. U ostalim slučajevima, vrednosti funkcije cilja koje su dobijene primenom GSA su manje u poređenju sa vrednostima dobijenim PSO i BCO metodama, što je prikazano u tabelama 2. i 3. 

\Figure{plot_3.pdf}{Konvergencija GSA algoritma za test scenario 2. Period analize $b=1$}{Convergence curve of GSA algorithm for test scenario 2. Period analysis $b=1$}

\Figure{plot_4.pdf}{Konvergencija PSO algoritma za test scenario 2. Period analize $b=1$}{Convergence curve of PSO algorithm for test scenario 2. Period analysis $b=1$}


\Figure{plot_5.pdf}{Konvergencija GSA algoritma za test scenario 2. Period analize $b=2$}{Convergence curve of GSA algorithm for test scenario 2. Period analysis $b=2$}

\Figure{plot_6.pdf}{Konvergencija PSO algoritma za test scenario 2. Period analize $b=2$}{Convergence curve of PSO algorithm for test scenario 2. Period analysis $b=2$}
...
\TableDouble{
      \begin{tabular}{p{0.12\linewidth}p{0.12\linewidth}p{0.1\linewidth}p{0.08\linewidth}p{0.08\linewidth}p{0.08\linewidth}p{0.08\linewidth}p{0.08\linewidth}}
        ...
        \hline
      \end{tabular}
}{Upoređivanje metoda za test scenario 2. Period analize $b=1$}{Comparison of methods for test scenario 2. Period analysis $b=1$}
...
\TableDouble{
      \begin{tabular}{p{0.12\linewidth}p{0.12\linewidth}p{0.1\linewidth}p{0.08\linewidth}p{0.08\linewidth}p{0.08\linewidth}p{0.08\linewidth}p{0.08\linewidth}}
        ...
        \hline
      \end{tabular}
}{Upoređivanje metoda za test scenario 2. Period analize $b=2$}{Comparison of methods for test scenario 2. Period analysis $b=2$}
...
\Figure{plot_7.pdf}{Konvergencija GSA algoritma za test scenario 3. Period analize $b=2$}{Convergence curve of GSA algorithm for test scenario 3. Period analysis $b=2$}

\Figure{plot_8.pdf}{Konvergencija PSO algoritma za test scenario 3. Period analize $b=2$}{Convergence curve of PSO algorithm for test scenario 3. Period analysis $b=2$}
...
\TableDouble{
      ...
      \hline
      \end{tabular}
}{Upoređivanje metoda za test scenario 3. Period analize $b=2$}{Comparison of methods for test scenario 3. Period analysis $b=2$}
...
\Figure{plot_9.pdf}{Konvergencija GSA i PSO algoritma za test raskrsnicu}{Convergence curve of GSA and PSO algorithm for test intersection}



% Tabela 4 
\TableDouble{
      \begin{tabular}{p{0.05\linewidth}p{0.08\linewidth}p{0.08\linewidth}p{0.1\linewidth}p{0.1\linewidth}p{0.1\linewidth}p{0.1\linewidth}p{0.1\linewidth}p{0.1\linewidth}}
        \toprule
        $ T = 1h $ & \multicolumn{2}{c}{\textbf{Postojeće stanje}}
        & \multicolumn{2}{c}{\textbf{GSA}}
        & \multicolumn{2}{c}{\textbf{PSO}} 
        & \multicolumn{2}{c}{\textbf{BCO}} \\ 
        \midrule
  Krit. &
  Prosečni vremenski gubici (s/voz) & 
  Broj neopsluženih vozila (voz) & 
  Prosečni vremenski gubici (s/voz) & 
  Neopslu-ženih vozila (voz) & 
  Prosečni vremenski gubici (s/voz) & 
  Neopslu-ženih vozila (voz) & 
  Prosečni vremenski gubici (s/voz) & 
  Neopslu-ženih vozila (voz) \\ 
  ...
  \bottomrule
      ...
      \end{tabular}
}{Upoređivanje metoda za test raskrsnicu}{Comparison of methods for test intersection}
